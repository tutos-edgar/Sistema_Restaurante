...
<head>
  ...
  <title>Generación de Vistas</title>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Generación de Vista</h5>
  ...
  <script>
    ...
    function onPlayerReady(event){
      ...
      iframe.on("click", function(){
        ...
        // $.ajax({
        //   url: "registro_click.php", // tu archivo PHP que procesará la acción
        //   method: "POST",
        //   data: {videoId: idVideo, accion: "click"},
        //   success: function(res){
        //     console.log("Click registrado:", res);
        //   },
        //   error: function(err){
