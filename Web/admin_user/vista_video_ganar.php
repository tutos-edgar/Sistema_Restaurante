...
echo '<script>var idVideo = "'.$idVideo.'"; var tipoVideo = "'.$tipoVideo.'"; var usuario = "'.$usuario.'"; var vistas = "'.$vistas.'";</script>';
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Ganar Vistas</h5>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (datos.success === "true") {
                  ...
                  window.location.href = "menu_ganar_vistas.php";                    
                } else {                   
                    $("#contenido").html('');
                    datosRecibidos = res.datos.datos || "No es Posible cargar los datos";
                    $("#contenido").html(datosRecibidos);
