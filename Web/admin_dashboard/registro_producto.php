...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3><i class="bi bi-plus-circle"></i>  Productos</h3>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
            <h5 class="modal-title"><i class="bi bi-plus-circle"></i> Registro de Producto</h5>
            ...
            <form id="fromRegistro">
                ...
                <div class="row g-3">
                    ...
                    <div class="toggle-switch">
                        <input type="checkbox" id="estadoSwitch" checked>
                        <label for="estadoSwitch">
                        <span class="switch"></span>
                        <span class="switch-label" id="estadoLabel"> ACTIVO</span>
                        </label>
                    </div>
                    </div>
